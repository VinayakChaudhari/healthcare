...
import studentService from '../services/patient.service';
...
const registerStudent = () => {
    console.log("inside registerPatients");
  //  c.preventDefault();
...
//  };
    ...
    // } else {
      ...
      studentService
        .create(studOb)
        .then((response) => {
            console.log("patients object before signing in "+studOb.dob+" "+studOb.dob+"  "+studOb.location);
          console.log('patients added successfully', response.data);
        ...
        <>
            ...
            <div class="form-group">
                ...
                placeholder="enter dob"/>
                    ...
                    <Link to="/adminlogin" class="loginInsted">Login as Doctor Instead?</Link>
                    <Link to="/studentlogin" class="loginInsted">Login as patients Instead?</Link>
