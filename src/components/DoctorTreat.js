...
import productService from '../services/subject.service';
import AddProduct from './AddSubject';
...
const DoctorProduct = () => {
  ...
  return (
    <div className='container'>
        ...
        <h1>Inside Doctor Page</h1>
      
      <hr />
      {/* <div>{location.state.id}</div> */}
      {displayCategoryFlag?(<div>
        <h1>List of tablets</h1>
      ...
      <div>
        ...
        <table className='table table-bordered table-striped' align="center">
          ...
          <tr><td> <Link to='/admincategory'>Back to Doctor Category</Link></td></tr>
        </table>
      </div>
